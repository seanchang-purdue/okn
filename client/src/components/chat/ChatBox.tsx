...
const ChatBox = ({
  ...
  return (
    <div className={`flex flex-col ${messages.length === 0 ? "" : "h-[calc(100vh-90px)]"}`}>
      <div 
      ...
      <div className="mt-auto mb-12">
        <form onSubmit={handleSubmit} className="w-full">
          <Textarea
            ...
            endContent={
              <Button type="submit" variant="light" isIconOnly disabled={loading || remainingQuestions === 0}>
        ...
        {!isConnected && (
          <p className="text-yellow-500">Disconnected. Trying to reconnect...</p>
        )}
      </div>
    </div>
  );
